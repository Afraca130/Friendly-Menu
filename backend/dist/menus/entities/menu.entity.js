...
const menu_translation_entity_1 = require("../../menu-translations/entities/menu-translation.entity");
let Menu = class Menu {
    id;
    name;
    price;
...
__decorate([
    (0, typeorm_1.OneToMany)(() => menu_translation_entity_1.MenuTranslation, (translation) => translation.menu),
